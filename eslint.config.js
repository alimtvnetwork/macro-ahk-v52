...
export default tseslint.config(
  ...
  // ── Staged id-denylist legacy quarantine: cb/obj ──────────────────
  // `cb` and `obj` are now banned globally for new/cleaned authored files.
  // These remaining files carry pre-existing debt and stay on the staged 0.8
  // backlog; do not add newly-cleaned files here.
  {
    files: [
