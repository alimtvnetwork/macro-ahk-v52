...
| Goal | Command |
|---|---|
| Pinned to a release (recommended) | `curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v36/releases/download/v2.228.0/install.sh \| bash` |
| Latest release (auto-resolve) | `curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.sh \| bash` |
...
```bash
curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v36/releases/download/v2.228.0/install.sh | bash
```

**PowerShell (Windows):**
```powershell
irm https://github.com/alimtvnetwork/macro-ahk-v36/releases/download/v2.228.0/install.ps1 | iex
```
...
**Bash — pinned dry-run:**
```bash
curl -fsSL https://github.com/alimtvnetwork/macro-ahk-v36/releases/download/v2.228.0/install.sh | bash -s -- --dry-run
```

**Bash — discovery dry-run:**
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.sh | bash -s -- --dry-run
```

**PowerShell — pinned dry-run:**
```powershell
& ([scriptblock]::Create((irm https://github.com/alimtvnetwork/macro-ahk-v36/releases/download/v2.228.0/install.ps1))) -DryRun
```

**PowerShell — discovery dry-run:**
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.ps1))) -DryRun
```
...
**Bash:**
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.sh | bash -s -- --dir /opt/marco-extension
```

**PowerShell:**
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.ps1))) -InstallDir 'D:\Tools\marco-extension'
```
...
**PowerShell:**
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.ps1))) `
...
MARCO_DOWNLOAD_BASE=https://ghe.corp.example \
  curl -fsSL https://ghe.corp.example/raw/alimtvnetwork/macro-ahk-v36/main/scripts/install.sh | bash
```
...
irm https://ghe.corp.example/raw/alimtvnetwork/macro-ahk-v36/main/scripts/install.ps1 | iex
```
...
4. **Sibling-repo discovery** _(opt-in, discovery mode only)_ — probes `macro-ahk-v36`, `…-v25`, … in parallel for a higher-numbered repo. Off by default. Run with `--enable-sibling-discovery` or `SIBLING_DISCOVERY_ENABLED=1`.
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.sh -o install.sh
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/macro-ahk-v36/main/scripts/install.ps1 -OutFile install.ps1
