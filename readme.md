...
```powershell
# Windows · PowerShell
irm https://github.com/aukgit/macro-ahk-v51/releases/download/v3.104.3/install.ps1 | iex
...
```bash
# macOS · Linux · Bash
curl -fsSL https://github.com/aukgit/macro-ahk-v51/releases/download/v3.104.3/install.sh | bash
