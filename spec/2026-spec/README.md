...
> **Canonical root:** `spec/2026-spec/` (renamed 2026-06-03 from `spec/01-prompt-spec-2026/`; moved 2026-06-03 from repo root into `spec/2026-spec/` to fit the 2026 grouping).
