...
/* Register the SDK's own per-project namespace so the documented
   ...
   Issue 66 — Option A. */
registerSdkSelfNamespace(marco, "3.77.4");
...
console.log("[marco-sdk] Riseup Macro SDK v3.77.4 initialized (RiseupAsiaMacroExt root + Logger + Projects.RiseupMacroSdk self-namespace + runtime self-test)");