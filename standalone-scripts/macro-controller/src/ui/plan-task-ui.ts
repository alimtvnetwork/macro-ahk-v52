...
export function buildPlanTaskPrompt(n: number): string {
  return [
    ...
    '',
    'Before executing later, check the task type and follow EVERY guideline source that exists. For coding tasks, check `.lovable/coding-guidelines.md`, `spec/coding-guidelines/`, root `coding-guidelines/`, and any `spec/XX-error-manage/` or `coding-guidelines/XX-error-manage/` folders. For SEO tasks, check `.lovable/seo-guidelines.md`, `spec/seo-guidelines/`, and root `seo-guidelines/`. Skip missing paths silently; read every `.md` inside folders that exist.',
    '',
    '## Checklist',
    '',
