...
.PARAMETER Repo
  GitHub owner/repo. Default: alimtvnetwork/macro-ahk-v36

.EXAMPLE
  # From a release page — installs that exact release (URL-pinned):
  irm https://github.com/alimtvnetwork/macro-ahk-v36/releases/download/v2.158.0/install.ps1 | iex
...
if (-not $script:MarcoDefaultRepo)        { $script:MarcoDefaultRepo        = 'alimtvnetwork/macro-ahk-v36' }
