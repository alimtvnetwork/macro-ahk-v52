...
.PARAMETER Repo
  GitHub owner/repo. Default: aukgit/macro-ahk-v52

.EXAMPLE
  # From a release page — installs that exact release (URL-pinned):
  irm https://github.com/aukgit/macro-ahk-v52/releases/download/v2.158.0/install.ps1 | iex
...
if (-not $script:MarcoDefaultRepo)        { $script:MarcoDefaultRepo        = 'aukgit/macro-ahk-v52' }
