...
|---|------|--------|--------|---------|
| 1 | **Priority 0.8** — continue staged authored-source id-denylist quarantine retirement (`cb`, `obj`, `fn`, `el`, `msg`, `ctx`) | High | Medium — 4 entries graduated; 269 quarantine entries remain | Effort budget |
