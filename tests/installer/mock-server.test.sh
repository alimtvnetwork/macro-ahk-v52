...
#
# Mock advertises macro-ahk-v50 (200) AND macro-ahk-v50 (200).
...
start_mock "MOCK_LATEST_TAG=v2.500.0 MOCK_SIBLINGS=macro-ahk-v50:200,macro-ahk-v50:200"
INSTALL_DIR="$(mktemp_install_dir)"
out="$(MARCO_API_BASE="${MOCK_BASE}" MARCO_DOWNLOAD_BASE="${MOCK_BASE}" \
...
start_mock "MOCK_LATEST_TAG=v2.500.0 MOCK_SIBLINGS=macro-ahk-v50:200"
INSTALL_DIR="$(mktemp_install_dir)"
out="$(MARCO_API_BASE="${MOCK_BASE}" MARCO_DOWNLOAD_BASE="${MOCK_BASE}" \
