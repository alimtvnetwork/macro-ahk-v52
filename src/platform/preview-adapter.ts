    ...
    const mocks: Record<string, string | number | boolean | null | object> = {
        ...
        GET_PROMPTS: {
            prompts: [
                ...
                { id: "12", name: "Next Tasks", text: "Next, execute the next pending task now, then end with a flat numbered remaining-tasks list.", order: 11, isDefault: true, category: "automation", createdAt: "2026-03-21T00:00:00Z", updatedAt: "2026-06-19T00:00:00Z" },
