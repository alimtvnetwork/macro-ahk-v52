...
function getFallbackDefaultPrompts(): PromptEntry[] {
    return [
        ...
        { id: "default-plan-steps", name: "Plan Steps", text: "# Plan in ${N}-Steps Plan (v7) — Evidence Enforcement\n\nParse N from the header and write exactly N steps. Do not execute anything this turn. Do not call plan approval tools. Save the plan to `.lovable/plans/pending/XX-<slug>.md`, include Verification and Evidence, and append only — do not submit or auto-repeat. Repetition belongs only to Repeat `▶ Start`.", order: 14, isDefault: true, category: "Plan", createdAt: "2026-06-19T00:00:00Z", updatedAt: "2026-06-19T00:00:00Z" },
