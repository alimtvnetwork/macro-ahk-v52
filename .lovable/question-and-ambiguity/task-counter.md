...
| 18 | 2026-06-02 | Initially created a thin `spec/2026-spec/README.md` pointer, then finalized the requested rename: completed spec now lives at `spec/01-prompt-spec-2026/` (renumbered 2026-06-03), with scripts/docs updated. | [59 — 2026-spec folder name](./59-2026-spec-folder-name.md) |
