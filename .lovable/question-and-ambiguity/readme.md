...
- [58 — 2026 Prompts Generic Spec — scope & placeholders](./58-2026-prompts-generic-spec.md) — Created `spec/2026-prompts-generic/` with 00-overview + 01-plan-tasks-1-20; all host XPaths left as `???`; cadence: 10 spec tasks per `next ten steps` turn (10 turns to cover T21–T120).
