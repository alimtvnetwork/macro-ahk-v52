...
- `spec/01-prompt-spec-2026/` — Prompt-management 2026 spec (renamed 2026-06-03 from `spec/2026-spec/`; children densely renumbered `01..20`, no sparse `1N0-` gaps). See `mem://architecture/prompt-spec-2026-layout` for full layout, rename history, and the `scripts/spec/apply-rename-map.mjs` rewriter.
