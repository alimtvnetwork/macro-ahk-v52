...
- Auto-derives `OLD_REPO_NAME` by decrementing trailing `-v<N>` (e.g. `macro-ahk-v33` → `macro-ahk-v33`).
...
- **Whole-token match only** (avoids `macro-ahk-v210` matching `macro-ahk-v33`).
