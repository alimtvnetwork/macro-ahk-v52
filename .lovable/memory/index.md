...
- [Prompt Spec 2026 layout](mem://architecture/prompt-spec-2026-layout) — Renamed 2026-06-03 from `spec/2026-spec/` → `spec/01-prompt-spec-2026/`; dense child numbering `01..20`; rewriter at `scripts/spec/apply-rename-map.mjs`; 8 scripts repaired in Phase E
