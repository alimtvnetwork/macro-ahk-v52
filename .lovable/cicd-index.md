...
| 12 | [`12-stale-repo-owner-ci-report-links.md`](./cicd-issues/12-stale-repo-owner-ci-report-links.md) | CI/CD status reports, badges, installers, and release docs pointed at stale `alimtvnetwork/macro-ahk-v52` instead of current `aukgit/macro-ahk-v52` | README + installer/release docs | ✅ Resolved | 2026-06-21 |
